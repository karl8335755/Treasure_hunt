  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-xl p-4 border-2 border-purple-400/50 hover:border-purple-400 transition-all duration-200 hover:scale-105 w-32 h-32 flex flex-col items-center justify-center group"
      >
        <div className="text-4xl mb-2 group-hover:scale-110 transition-transform duration-200">
          {AVATARS[currentAvatar].emoji}
        </div>
        <div className="text-purple-300 font-bold text-sm text-center">{AVATARS[currentAvatar].name}</div>
        <div className="text-purple-200 text-xs text-center">Click to change</div>
      </button>

      {/* Avatar Selection Dropdown */}
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 bg-black/90 rounded-xl border-2 border-purple-400/50 p-4 z-50 min-w-80">
